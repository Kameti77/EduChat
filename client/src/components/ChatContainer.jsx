...
const ChatContainer = () => {
    ...
    return selectedUser ? (
        <div className='h-full overflow-scroll relative backdrop-blur-lg'>
            <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
                ...
                <img onClick={() => setSelectedUser} src={assets.arrow_icon} alt="" className='md:hidden
            max-w-7'/>
            ...
            <div className="flex flex-col h-[calc(100%-120px)] overflow-scroll p-3 pb-6">
                {messages.map((msg, index) => (
                    <div key={index} className={`flex items-end gap-2 justify-end ${msg.senderId
                        ...
                        {msg.image ? (
                            <img src={assets.immage} alt="" className='max-w-[230px] border 
            ...
            <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3'>
                <div className="flex-1 flex items-center bg-gray-100/12 px-3 rounded-full">
                    <input nChange={(e) => setInput(e.target.value)} value={input}
    ...
    bg-white/10 max-md:hidden">
            <img src={assets.logo_icon} alt="" className='max-w-32' />
