...
const Sidebar = () => {
    ...
    return (
        <div className={`bg-[#A0A3C9]/20 h-full p-5 rounded-r-xl overflow-y-scroll 
            ...
            <div className="flex flex-col">
                {filteredUsers.map((user, index) => {
                    ...
                    ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                            ...
                            {(unseenMessages?.[user._id] ?? 0) > 0 && <p className='absolute top-4 right-4 text-xs h-5 w-5 
                    flex justify-center rounded-full items-center bg-violet-500/50'>
